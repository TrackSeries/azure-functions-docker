...
RUN BUILD_NUMBER=$(echo ${HOST_VERSION} | cut -d'.' -f 3) && \
    git clone --branch v${HOST_VERSION} https://github.com/TrackSeries/azure-functions-host /src/azure-functions-host && \
...
RUN EXTENSION_BUNDLE_VERSION=1.3.3 && \
    ...
    EXTENSION_BUNDLE_VERSION_V2=2.2.0 && \
